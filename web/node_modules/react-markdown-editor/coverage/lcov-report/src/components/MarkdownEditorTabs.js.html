...
<html lang="en">
<head>
    <title>Code coverage report for src/components/MarkdownEditorTabs.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> MarkdownEditorTabs.js
    </h1>
    <div class='clearfix'>
...
102
103
104</td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
&nbsp;
  handleMDEditorTabsInteractionStoreUpdated: <span class="fstat-no" title="function not covered" >fu</span>nction(storeState) {
<span class="cstat-no" title="statement not covered" >    if (storeState.activeTab != null) {</span>
<span class="cstat-no" title="statement not covered" >      this.setState({activeTab: storeState.activeTab});</span>
    }
  },
&nbsp;
  render: function() {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if(this.props.hasOwnProperty('styles') &amp;&amp; this.props.styles.hasOwnProperty('styleActiveTab')) {
        Object.assign(styleActiveTab, this.props.styles.styleActiveTab);
    }
&nbsp;
    var editorTabStyle;
    var previewTabStyle;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.state.activeTab === 0) {
      editorTabStyle = styleActiveTab;
      previewTabStyle = styleTab;
    } else <span class="cstat-no" title="statement not covered" >if (this.state.activeTab === 1) {</span>
<span class="cstat-no" title="statement not covered" >      previewTabStyle = styleActiveTab;</span>
<span class="cstat-no" title="statement not covered" >      editorTabStyle = styleTab;</span>
    }
&nbsp;
    return (
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Aug 22 2017 11:28:46 GMT+0200 (CEST)
</div>
</div>
