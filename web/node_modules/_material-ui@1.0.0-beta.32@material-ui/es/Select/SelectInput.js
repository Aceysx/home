...
class SelectInput extends React.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), this.state = {
      anchorEl: null,
      open: false
    }, this.ignoreNextBlur = false, this.isControlled = this.props.open !== undefined, this.update = this.isControlled ? ({ event, open, anchorEl }) => {
      if (open) {
    ...
    } : ({ open, anchorEl }) => this.setState({ open, anchorEl }), this.handleClick = event => {
