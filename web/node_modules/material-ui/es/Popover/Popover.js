  ...
  render() {
    const _props = this.props,
      ...
      action
          ...
          other = _objectWithoutProperties(_props, ['anchorEl', 'anchorOrigin', 'anchorPosition', 'anchorReference', 'children', 'classes', 'elevation', 'getContentAnchorEl', 'marginThreshold', 'onEnter', 'onEntered', 'onEntering', 'onExit', 'onExited', 'onExiting', 'open', 'PaperProps', 'role', 'transformOrigin', 'transitionClasses', 'transitionDuration', 'action']);

    return React.createElement(
      Modal,
      _extends({ open: open, BackdropProps: { invisible: true } }, other),
      React.createElement(
        Grow,
        {
          appear: true,
