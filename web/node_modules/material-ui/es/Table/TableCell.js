...
function TableCell(props, context) {
  const {
    ...
    padding
        ...
        other = _objectWithoutProperties(props, ['children', 'classes', 'className', 'component', 'sortDirection', 'numeric', 'padding']);
  const { table } = context;
  let Component;
  if (component) {
    Component = component;
  ...
  return React.createElement(
    Component,
    _extends({ className: className, 'aria-sort': ariaSort }, other),
    children
  );
}
