  ...
  render() {
    const _props = this.props,
      ...
      type
          ...
          other = _objectWithoutProperties(_props, ['anchor', 'children', 'classes', 'className', 'elevation', 'ModalProps', 'onClose', 'open', 'SlideProps', 'theme', 'transitionDuration', 'type']);
    ...
    const drawer = React.createElement(
      Paper,
      {
        ...
        square: true,
        className: classNames(classes.paper, classes[`paperAnchor${capitalizeFirstLetter(anchor)}`], {
